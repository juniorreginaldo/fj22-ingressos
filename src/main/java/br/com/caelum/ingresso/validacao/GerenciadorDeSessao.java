...
public class GerenciadorDeSessao {
	...
	private List<Sessao> sessoesDaSala;
		...
		private boolean horarioIsConflitante(Sessao sessoaExistente, Sessao sessaoNova) {
			LocalDate hoje = LocalDate.now();
			
			LocalDateTime horarioSessaoExistente = sessoaExistente.getHorario().atDate(hoje);
			LocalDateTime terminoSessaoExistente = sessoaExistente.getHorarioTemino().atDate(hoje);
			LocalDateTime horarioSessaoNova = sessaoNova.getHorario().atDate(hoje);
			LocalDateTime terminoSessaoNova = sessaoNova.getHorarioTemino().atDate(hoje);
